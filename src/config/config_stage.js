...
const config = {
    workbench: {
        dashboardUrl: "https://workbench-ui.stg.arm.gov",
        modules: [
            {
                id: "find",
                label: "Find",
                ...
                contents: [
                    {
                        ...
                        url: "https://armweb-stage.ornl.gov/discovery",
                        active: false,
                        comingSoon: false,
                    },
                    {
                        label: "Download data through REST API",
                        url: "https://armweb-stage.ornl.gov/armlive",
                        active: false,
                        comingSoon: false,
                    },
                ],
                ...
                contents: [
                    {
                        ...
                        url: "https://data-studio-ui.stg.arm.gov",
                        active: false,
                        comingSoon: false,
                    },
                ],
