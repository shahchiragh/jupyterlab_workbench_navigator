...
<template>
    <div>
        <div id="workbench-navigator" class="px-3" no-gutters @click="$bvModal.show('workbench-modal')">
            Data Workbench
        </div>
        <b-modal id="workbench-modal" size="xl" body-class="p-4" content-class="rounded-0" hide-header hide-footer
            centered>
